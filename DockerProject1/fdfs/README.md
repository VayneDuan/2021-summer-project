...
## customer defined env-vars:
* GROUP_NUM: -1 for tracker positive int for storage
* GROUP_NAME: when GROUP_NUM==-1 GOURP_NAME=tracker, and when GROUP_NUM>0 GROUP_NAME="group${GROUP_NUM} (this resolution is donw in the docker-entrypoint.sh)
